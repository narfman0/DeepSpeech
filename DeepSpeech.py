...
def calculate_mean_edit_distance_and_loss(model_feeder, tower, dropout, is_training, reuse):
    r'''
...
def train(server=None):
    ...
    results_tuple, gradients, mean_edit_distance, loss = get_tower_results(model_feeder, optimizer, is_training=is_training_ph)
